...
Other useful documents include [DETAILS](DETAILS.md), covering some of the notable internal workings of Family BASIC that have been discovered through exploration of the disassembly, and [BUGS](BUGS.md), which covers some of the *bugs*, and weird coding choices, uncovered in the disassembly.
